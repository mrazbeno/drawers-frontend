...
const Index = () => {
    ...
    async function createRoom() {
        const resp = await fetch(`${process.env.NEXT_PUBLIC_WS_URL}/rooms`, { method: "POST" })
        if (resp.status !== 201) {
            throw new Error("asd")
        }
    ...
    async function joinRoom() {
        const resp = await fetch(`${process.env.NEXT_PUBLIC_WS_URL}/rooms/${roomId}`, { method: "GET" })
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex flex-col gap-2">
                            ...
                            <video title="Canvas demo video" id="demo_video" className="rounded-md relative shadow-[var(--shadow-card)] w-full h-auto" autoPlay muted loop playsInline poster="/demo/home_draw_poster.png">
                                <source src="/demo/home_draw_sample.mp4" />
